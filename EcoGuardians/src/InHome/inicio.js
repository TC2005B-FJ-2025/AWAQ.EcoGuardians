...
const Inicio = () => {
  return (
    <section className="flex flex-col items-center justify-center text-center min-h-screen w-full">
      ...
      <h2 className="text-7xl text-verde-claro font-bold pt-1 mb-10">Ecoguardianes 2.0</h2>
      <div className="flex justify-center mb-5">
        <img src={logo} alt="Imagen del juego Ecoguardians" className="w-[656px] h-[253px] rounded-[18px] object-cover" />
      </div>
      <div className="flex gap-4 mt-5">
        <button className="bg-white text-black text-lg px-5 py-2 rounded-full border-black border-2 hover:bg-verde-fuerte hover:border-transparent hover:text-white transition">
          Jugar como invitado
        </button>
        <button className="bg-verde-claro text-white text-lg px-5 py-2 rounded-full hover:bg-verde-fuerte transition">
          Iniciar sesión
        </button>
      </div>
    </section>
...
const Nosotros = () => {
  ...
  return (
    <section className="flex flex-col items-center text-center p-10">
      <h2 className="text-5xl font-bold text-verde-claro mb-5">Sobre Nosotros</h2>
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-4xl w-full">
        ...
        <div className="max-w-md text-left">
          ...
          <button className="text-verde-claro font-bold mt-2 hover:underline" onClick={() => setMostrarTexto(!mostrarTexto)}>
