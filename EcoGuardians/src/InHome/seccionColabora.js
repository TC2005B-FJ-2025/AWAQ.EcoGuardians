    ...
    <div className="w-full bg-white">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 divide-x divide-gray-600">
        ...
        <div className="flex-grow border-t border-gray-600"></div>
          ...
          <button className="bg-[#5F874E]  text-white text-sm px-5 py-2 rounded-full hover:bg-green-800 transition">
        ...
        <div className="flex-grow border-t border-gray-600"></div>
          ...
          <button className="bg-[#5F874E] 0 text-white text-sm px-5 py-2 rounded-full hover:bg-green-800 transition">
